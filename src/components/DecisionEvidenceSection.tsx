  ...
  const pipelineSteps = [
    {
      num: '01',
      stage: 'UNDERSTAND',
      tag: 'PARCEL PARSING & TARGET OBJECTIVES',
      title: 'Candidate Portfolio Understanding',
      description: 'Atlas parses candidate property portfolios and establishes physical criteria for commercial underwriting.',
    ...
    },
    {
      ...
      tag: 'MIREYE API & SPATIAL DATA INTEGRATION',
      title: 'Physical Evidence Synthesis',
      description: 'Atlas queries Mireye physical endpoints and combines physical data with commercial datasets.',
      metricLabel: 'AGENT ACTION:',
      metricValue: 'Evidence Gathered',
    },
    {
      num: '03',
      stage: 'REASON',
      tag: 'DEAL-KILLER AUDIT & REJECTION LEDGER',
      title: 'Flaw Screening & Comparative Ranking',
      description: 'Atlas screens fatal physical flaws, cuts unviable properties with written proof, and ranks candidate sites.',
      metricLabel: 'AGENT ACTION:',
    ...
    },
    {
      num: '04',
      stage: 'DELIVER',
      tag: 'COMMERCIAL DELIVERABLES & SITE CONTROL',
      title: 'Investment Memos & Option Agreements',
      description: 'Atlas generates investment committee memos and draft land option agreements ready for acquisition review.',
      metricLabel: 'AGENT ACTION:',
      metricValue: 'Memos Delivered',
    },
  ];
